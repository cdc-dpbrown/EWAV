...
namespace Ewav.Web.EpiDashboard
{
    ...
    public class FilterCondition
    {
        ...
        {            
            ...
            conditionBuilder.Append(sl.PARANTHESES_OPEN);
            
            if (IsBetween)
            {
                conditionBuilder.Append(this.ColumnName);
                conditionBuilder.Append(sl.SPACE);
                conditionBuilder.Append(sl.GREATER_THAN_OR_EQUAL);
                conditionBuilder.Append(sl.SPACE);
                ...
                conditionBuilder.Append(this.ColumnName);
                conditionBuilder.Append(sl.SPACE);
                conditionBuilder.Append(sl.LESS_THAN_OR_EQUAL);
                conditionBuilder.Append(sl.SPACE);
            ...
            conditionBuilder.Append(sl.PARANTHESES_CLOSE);
