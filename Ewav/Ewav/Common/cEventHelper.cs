  ...
  public class cEventHelper
    {
      ...
      //  
        ...
        //--------------------------------------------------------------------------------
        public  void RemoveAllEventHandlers(object obj)
        {
            RemoveEventHandler(obj, "");
        }

        //--------------------------------------------------------------------------------
        public  void RemoveEventHandler(object obj, string EventName)
        {
            if (obj == null)
                return;
           ...
           //  EventHandlerList static_event_handlers = null;
            ...
            {
                if (EventName != "" && string.Compare   (EventName, fi.Name  ) != 0)
                    continue;
